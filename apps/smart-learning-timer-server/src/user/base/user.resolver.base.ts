...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [FocusAnalytics], { name: "focusAnalyticsItems" })
  async findFocusAnalyticsItems(
    @graphql.Parent() parent: User,
    @graphql.Args() args: FocusAnalyticsFindManyArgs
  ): Promise<FocusAnalytics[]> {
    const results = await this.service.findFocusAnalyticsItems(parent.id, args);
  ...
  @graphql.ResolveField(() => [FocusSession], { name: "focusSessions" })
  async findFocusSessions(
    @graphql.Parent() parent: User,
    @graphql.Args() args: FocusSessionFindManyArgs
  ): Promise<FocusSession[]> {
    const results = await this.service.findFocusSessions(parent.id, args);
